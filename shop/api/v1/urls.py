...
admin_urls = [
    ...
    path(
        "admin/activation/<uuid:shop_id>/",
        ShopActivationView.as_view(),
        name="shop-activation",
    ),
    path(
        "admin/shop-details/<uuid:shop_id>/",
        ShopDetailsForAdminView.as_view(),
        name="shop-details-for-admin",
    ),
]
