...
from .views import (
  ...
  UserDetailsUpdateView, ForgetPasswordView, ResetPasswordView, GetUserListView,
  UserDetailsForAdminView, UserActivationView
  )
...
admin_urls = [
  ...
  path('admin/user-activation/', UserActivationView.as_view(), name="user-activation"),
]
